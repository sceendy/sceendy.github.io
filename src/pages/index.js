  ...
  <div>
    <div className='grid--two'>
      ...
      <div>
        ...
        <p>I love building empowering, functional, efficient, and thoughtfully designed web applications. Also, I tend to work remotely most days.</p>
        <p>There are some great engineers that I have worked with and learned a lot from over the past few years. They have some <a href='https://www.linkedin.com/in/sceendy#recommendations' target='_blank' rel='noopener'>good things to say about me</a>. So, that's pretty awesome.</p>
        <p>I live in Austin with my husband and dog. I love JavaScript. I enjoy running, drinking coffee, eating waffles, and traveling.</p>
        <a href='assets/web-resume.pdf' className='btn u--float-right' target='_blank'>View Resume (.pdf)</a>
      </div>
    </div>
    ...
    <div className='grid--three'>
      <figure>
        ...
        <figcaption>
          ...
          <p>A product suite that provides tools for clients to manage all of their content, users, and products.</p>
        </figcaption>
      </figure>
      <figure>
        <img
      ...
      <figure>
        ...
        <figcaption>
        <a href='https://kalkomey.com/' target='_blank' rel='noopener'>Foundry (internal CMS for courses)</a><br/>
